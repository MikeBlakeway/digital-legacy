      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-12 sm:px-10 sm:py-16">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Link
            ...
            className="rounded-md border border-stone-300 px-4 py-2 text-sm font-medium text-stone-700 transition hover:border-teal-400 hover:bg-teal-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:border-teal-700 dark:hover:bg-teal-950/20"
          >
            Family access
          </Link>
        </header>
